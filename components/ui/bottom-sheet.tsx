  ...
  return (
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Content
        className={`fixed inset-x-0 bottom-0 z-50 max-h-[85vh] overflow-y-auto rounded-t-[28px] border border-border bg-white p-4 shadow-[0_-4px_24px_rgba(0,0,0,0.10)] backdrop-blur data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:slide-out-to-bottom-6 data-[state=open]:slide-in-from-bottom-6 ${className}`}
        {...props}
      >
